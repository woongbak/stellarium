...
public:
    ...
    //! @param x      X position of the centre on the screen in pixels.
    //! @param y      Y position of the centre on the screen in pixels.
    //! @param width  Width in pixels.
    //! @param height Height in pixels.
    //! @param angle  Angle to rotate the ellipse around its center in degrees.
